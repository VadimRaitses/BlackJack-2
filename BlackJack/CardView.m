...
- (void)drawRect:(CGRect)rect {
    ...
    if(self.faceUp)
    {
       ...
       // UIImage *faceImage = [UIImage imageNamed:@"K♥"];
       if(faceImage){
      ...
      [faceImage drawInRect:imageRect];
        ...
        [[UIImage imageNamed:@"afeka"] drawInRect:self.bounds];
    }
...
- (void)drawCorners {
    ...
    CGContextRef context = UIGraphicsGetCurrentContext(); // get contex
...
- (void)setup {
    self.backgroundColor = [UIColor clearColor];     // nil can also be used
    self.opaque = NO;
